      ...
      <header className={
        ...
        <nav className='flex items-center justify-between nike-container'>
            <div className='flex items-center gap-2'>
                <h1 className={`font-bold uppercase text-slate-100 ${navState && "text-slate-900"}`}>FimtyShop</h1>
                <h1 className={`font-normal text-slate-100 ${navState && "text-slate-900"}`}>x</h1>
                <img
                    src={logo}
                    alt="logo/img"
