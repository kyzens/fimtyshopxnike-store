...
const Cart = () => {
  ...
  const priceFormat = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(totalAmount);
          ...
          {cartItems?.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
            ...
            <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
              <div className="flex items-center justify-between mb-2">
                ...
                <h1 className="text-sm rounded bg-theme-cart text-slate-100 px-1 py-0.5">{priceFormat}</h1>
              </div>
              <div className="grid items-center gap-2">
                <p className="text-sm font-medium text-center">Pajak akan dihitung saat pengiriman.</p>
