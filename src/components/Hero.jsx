  ...
  return (
    <>
        <div className='relative h-auto w-auto flex flex-col'>
            ...
            lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto 
            ...
            items-center justify-items-center nike-container'>
                ...
                justify-items-center mt-28 md:mt-24'>
                    ...
                    bg-slate-200 shadow-slate-200 rounded-xl my-5'>
                        {btntext}
                    </button>
                    <div className='grid items-center gap-5
                    md:gap-3 absolute top-[33vh] lg:top-[27vh]
                    ...
                    top-[33vh] lg:top-[27vh] right-0 gap-3'>
                ...
                <div className='flex items-center'>
                    <img 
                        src={img}
                        alt='hero-img/img'
                        className='w-auto h-[45vh] lg:h-[35vh] mt-4
